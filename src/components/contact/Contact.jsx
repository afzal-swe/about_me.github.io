      ...
      <div className='container contact_container'>
        <div className='contact_option'>
          <article className='contact_option'>
            ...
            <h4>Email</h4>
            <h5>contact@engrafzalhossen.com</h5>
            <a href="contact@engrafzalhossen.com" target="_blank">Send a message</a>

          </article>
          <article className='contact_option'>
            <RiMessengerLine className='contact_option-icon'/>
            <h4>Messenger</h4>
            <h5>Engr Afzal Hossen</h5>
            <a href="contact@engrafzalhossen.com" target="_blank">Send a message</a>
          ...
          <article className='contact_option'>
            ...
            <h4>Whatsapp</h4>
            <h5>+8801811178307</h5>
            <a href="https://api.whatsapp.com/send?phone+8801811178307" target="_blank">Send a message</a>
